...
<body>
	...
	<div class="product">
		<div class="container">
			<div class="spec ">
				<h3 style="margin-top:50px ;">Order Page</h3>
				<div class="ser-t">
					<b></b>
					<span><i></i></span>
					<b class="line"></b>
			...
			<div class=" con-w3l agileinf">
				...
				?>
							<div class="col-md-3 pro-1">
								<div class="col-m" style="margin-left: 30px;padding-bottom:20px;">
							...
							<div class="col-m" style="margin-left: 30px;padding-bottom:20px;">
								...
								<div class="mid-1">
									<div class="women">
										...
										<p><em class="item_price cls"> Price ₹<?php echo $res2['product_price']; ?></em></p>
										<div class="clearfix"></div>


										<p><em class="item_qty cls"> Qty <?php echo $res2['product_qty']; ?></em></p>
