        ...
        <div class="container">
            ...
            <div class="head-t">
                <ul class="card">
                    ...
                    <li><a href="vendor-index.php" ><i class="fa fa-user" aria-hidden="true"></i>About Us</a></li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
           <img class="first-slide" src="images/p1.png" alt="First slide">
       
        </div>
        <div class="item">
          <img class="second-slide " src="images/p2.png" alt="Second slide">
         
        </div>
        <div class="item">
          <img class="third-slide " src="images/p3.png" alt="Third slide">
