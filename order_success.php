		...
		<div class="row justify-content-center">
			<div class="table-responsive">
				...
				$res2= mysqli_fetch_assoc($data2);
				 ...
				 ?>
				<h2 class="text-center text-black mb-5" style="margin-top: 20px;"> <u>Order Placed</u> </h2>
...
/*						$sent= array();
			...
			';
				...
				<tr class="total">
					...
					<td style="padding: 5px;vertical-align: top;">	<td style="padding: 5px;vertical-align: top;text-align: right;font-weight: bold;">
						 	</td>
